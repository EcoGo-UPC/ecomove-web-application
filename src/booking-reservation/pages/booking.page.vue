...
<template>
  <div class="flex flex-col min-h-screen bg-blue-100">
    <navbar-component />
    <div class="flex-grow">
      <main class="p-20 flex flex-col items-center gap-20 mt-20"> <!-- Añade mt-20 para alejarlo del Navbar -->
        ...
        <div class="w-full justify-center flex">
          <div class="bg-primary-400 flex justify-center items-center rounded-lg border-black border-4 max-w-[70%] md:max-w-[25%]">
            <span class="text-xl md:text-4xl px-8 font-bold">#56453</span>
          </div>
        </div>
        <div class="flex justify-center">
          <button class="py-2 px-4 bg-primary-800 text-white hover:bg-primary-700" style="border-radius: 8px;" @click="">
            Volver a generar
          </button>
        </div>
      </main>
